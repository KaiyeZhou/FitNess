...
def classify_count_noskip(data1):
    ...
    for i in range(len(data1)):   # i-(0, N), N frames
        # 身高： |左眼 - 左脚踝|
        height.append(data1[i][1][15] - data1[i][1][1])
        ...
        ### deep squat
        if data1[i][1][9] < data1[i][1][7] and data1[i][1][10] < data1[i][1][8] and (abs(data1[i][1][5] - data1[i][1][13]) > 90 or abs(data1[i][1][6] - data1[i][1][14]) > 90):
            temp2 += 1
    ...
    maxheight = max(height[180:360])
    ### dead lift  
    if temp1 > 180:
        for i in range(len(data1)):
            if flag == 0:
                if i + 24 < len(data1) and data1[i][1][9] - data1[i + 24][1][9] > 100:
                    flag = 1
                    # if start_frame and i - start_frame[-1] > 30:
                    start_frame.append(i)
                
            if flag == 1:
                if i + 24 < len(data1) and abs(data1[i + 24][1][9] - data1[start_frame[0]][1][9]) < 15:                    
                    flag = 0
                    count1 += 1
                    maxList.append(maxx)
                    maxx = 0
        ...
        return a, count1, maxList, maxheight, start_frame
        # print(start_frame)
        # print(maxList)
    ...
    if temp2 > 180:
        for i in range(len(data1)):
            if flag == 0:
                if i + 24 < len(data1) and data1[i + 24][1][9] - data1[i][1][9] > 90:
                    flag = 1        
                    start_frame.append(i)
            if flag == 1:
                if i + 24 < len(data1) and abs(data1[i + 24][1][9] - data1[start_frame[-1]][1][9]) < 20:            
                    flag = 0
                    count2 += 1
                    maxList.append(maxx)
                    maxx = 0
        ...
        return b, count2, maxList, maxheight, start_frame
        # print(start_frame)
        # print(maxList)
        # for i in range(len(maxList)):
        #         if maxList[i] > 160:
    ...
    if temp3 > 60:
        for i in range(len(data1)):
            if flag == 0:
                if i + 24 < len(data1) and (data1[i + 24][1][9] - data1[i][1][9] > 120 or data1[i + 24][1][10] - data1[i][1][10] > 120):
                    flag = 1        
                    start_frame.append(i)
            if flag == 1:
                if i + 24 < len(data1) and (abs(data1[i + 24][1][9] - data1[start_frame[-1]][1][9]) < 5 or abs(data1[i + 24][1][10] - data1[start_frame[-1]][1][10]) < 5):
                    flag = 0
                    count3 += 1
                    maxList.append(maxx)
                    maxx = 0
        ...
        return c, count3, maxList, maxheight, start_frame
        # print(start_frame)
        # print(maxList)
        # for i in range(len(maxList)):
        #         if maxList[i] > 130:
